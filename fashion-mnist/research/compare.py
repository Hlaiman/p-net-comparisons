...
from config import train_images_path, test_images_path, train_data_path, test_data_path, model_path, classes_num
from utils.eval_utils import test_keras_model, test_multioutput_pnet_model_with_csv
...
keras_examples_count = test_keras_model(keras_model, test_images_path)

pnet_right, \
pnet_inference_time, \
pnet_examples_count = test_multioutput_pnet_model_with_csv(pnet_model, test_data_path, classes_num)
